...
if("FALSE" STREQUAL "TRUE")
  set(image_geometry_SOURCE_PREFIX /home/aniket/URC_final/master/rover-control/src/image_geometry)
  set(image_geometry_DEVEL_PREFIX /home/aniket/URC_final/master/rover-control/devel)
  ...
  set(image_geometry_INSTALL_PREFIX /home/aniket/URC_final/master/rover-control/install)
...
if(NOT "include;/usr/local/include;/usr/local/include/opencv " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/aniket/URC_final/master/rover-control/install/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
