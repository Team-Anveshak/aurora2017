...
if("FALSE" STREQUAL "TRUE")
  set(opencv_tests_SOURCE_PREFIX /home/aniket/URC_final/master/rover-control/src/opencv_tests)
  set(opencv_tests_DEVEL_PREFIX /home/aniket/URC_final/master/rover-control/devel)
  ...
  set(opencv_tests_INSTALL_PREFIX /home/aniket/URC_final/master/rover-control/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'opencv_tests' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/aniket/URC_final/master/rover-control/install/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
